...
const Form = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const data = {
            ...
            topic: mainTopics[values.topic].value,
            topicLabel: mainTopics[values.topic].label,
            subTopic:
                values.mainTopic !== 7
                    ? subTopics[values.topic][values.subTopic].value
                    : values.otherTopic,
            subTopicLabel:
                values.mainTopic !== 7
                    ? subTopics[values.topic][values.subTopic].label
                    : values.otherTopic,
        ...
        await axios
            .post(
                'https://school-server-2022.herokuapp.com/updateDoc/' +
                    info.uid,
                data
            )
